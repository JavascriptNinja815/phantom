...
const asoBlacklist = require("../controllers/asoblacklist");
...
module.exports = function (app) {
  ...
  app.post("/api/asoblacklist/page",      auth.ensureHost, auth.loggedIn, asoBlacklist.getAsoBlacklist);
  app.get ("/api/asoblacklist/:id",       auth.ensureHost, auth.loggedIn, asoBlacklist.getAsoBlacklistItem);
  app.post("/api/asoblacklist",           auth.ensureHost, auth.loggedIn, asoBlacklist.editAsoBlacklistItem);
  app.post("/api/asoblacklist/delete",    auth.ensureHost, auth.loggedIn, asoBlacklist.deleteAsoBlacklistItem);
