...
module.exports.newOrUpdateLink = function(req, res) {
  var { _id, link_generated, link_voluum, link_safe,
    description, tags, use_ip_blacklist, block_corporate, criteria, criteria_disallow,
    auto_blacklist_count, network, angle, enable_at, disable_at, cpc, payout, allowGeo } = req.body;
